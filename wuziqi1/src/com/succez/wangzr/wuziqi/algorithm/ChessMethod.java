...
public class ChessMethod {
	...
	/**
	 * 返回棋盘中某一点的下棋信息
	 * @param positionX 要查询的点的横坐标
	 * @param positionY 要查询的点的纵坐标
	 * @return 该点的下棋信息
	 */
	...
	/**
	 * 下棋函数，即改变table中某一点的状态值
	 * @param positionX 下棋点的横坐标
	 * @param positionY 下棋点的纵坐标
	 * @param chessColor 要下的棋的颜色
	 */
	public void setable(int positionX,int positionY,int chessColor){
		table[positionX][positionY]=chessColor;
	}
